...
# Test cases - format: "name:input_dir_path"
# NOTE: DFTB+ needs to run inside a directory where the input files are staged.
TEST_CASES=(
    "spinlock:/work2/05392/cylu/share/reu_2026/2.project/2.examples/dftb+/spinlock"
)
