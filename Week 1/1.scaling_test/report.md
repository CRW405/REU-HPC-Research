...
After 56 mpi, performance inrease begins to decrease
...
the gains from adding nodes falls at 4 nodes, while adding MPI tasks falls at 56 tasks.

Performace gained by adding MPI tasks:
1:  +% 0.0
...
Performace gained by adding nodes:
1:  +% 0.0
