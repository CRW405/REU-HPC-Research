...
export PEAK_MPI_REAL_FINALIZE=${PEAK_MPI_REAL_FINALIZE}
export PEAK_OUTPUT_AGGREGATION=${PEAK_OUTPUT_AGGREGATION}
export PEAK_UNSAFE_GUM_PROLOGUE_POLICY=${PEAK_UNSAFE_GUM_PROLOGUE_POLICY}
